        ...
        <ul class="slides-container">
            <li class="text-left">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Welcome To <br> Crystallo Footwear</strong></h1>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="images/klompenukir.jpg" alt="" />
                        <a class="btn hvr-hover" href="">Klompen Ukir</a>
                    </div>
                    <!-- <div class="shop-cat-box">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="images/sandalcasual2.jpg" alt="" />
                        <a class="btn hvr-hover" href="">Sandal Casual</a>
                    </div>
                    <!-- <div class="shop-cat-box">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="images/wedges.jpg" alt="" />
                        <a class="btn hvr-hover" href="">Wedges</a>
                    </div>
                    <!-- <div class="shop-cat-box">
