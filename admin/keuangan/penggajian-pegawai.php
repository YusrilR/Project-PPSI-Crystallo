                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="text-align: center; width: 15%">
                                                    <button type="button" class="edit btn-primary btn-sm btn-flat btn-xs" data-toggle="modal" id="btn_edit" data-id="<?php echo $mysql['Id_PenggajianPegawai']; ?>" data-target='#updateModal<?php echo $mysql["Id_PenggajianPegawai"] ?>'><i class="fa fa-pencil"></i> Edit</button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    <?php } ?>
                        ...
                        <div class="modal-body">
                            <form action="./function/function_penggajianpegawai.php?act=updatepenggajian" method="post" role="form">
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="Id_PenggajianPegawai" name="Id_PenggajianPegawai" placeholder="Text" class="form-control" value="<?php echo $row['Id_PenggajianPegawai']; ?>" readonly></div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Tanggal Penggajian</label></div>
                                    <div class="col-12 col-md-9"><input type="date" id="Tgl_PenggajianPegawai" name="Tgl_PenggajianPegawai" placeholder="Deskripsi" class="form-control" value="<?php echo $row['Tgl_PenggajianPegawai']; ?>" readonly></div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nama Pegawai</label></div>
                                    <div class="col-12 col-md-9">
                                        <select name="Id_Pegawai" id="Id_Pegawai_edit" class="form-control" required readonly>
                                            <?php
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="Id_Gaji_edit" name="Id_Gaji" class="form-control" value="<?php echo $row['Id_Gaji']; ?>" readonly></div>
                                </div>
                                <!-- <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Deskripsi Gaji</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="Deskripsi_Gaji_edit" name="Deskripsi_Gaji" class="form-control" readonly></div>
                                </div> -->
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Kehadiran/Bulan</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="Jumlah_Kehadiran_edit" name="Jumlah_Kehadiran" class="Jumlah_Kehadiran_edit form-control" value="<?php echo $row['Jumlah_Kehadiran']; ?>" readonly></div>
                                </div>
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="Besar_Gaji_edit" name="Besar_Gaji" class="form-control" readonly>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-money"></i></div>
                                            <input type="text" id="Grand_Total_edit" name="Grand_Total" class="Grand_Total_edit form-control" value="<?php echo $row['Grand_Total']; ?>" readonly>
                                            <div class="input-group-addon">,00</div>
                                        </div>
                                    </div>
                                </div>
