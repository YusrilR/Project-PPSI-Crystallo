...
$query = mysqli_query($koneksi, "SELECT max(username) as kodeTerbesar FROM tabel_user");
...
<body>
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Data Tabel Admin</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <?php
                                    $no = 1;
                                    $database = "SELECT * FROM tabel_user";
                                    ...
                                    ?>
                                        <tbody>
                                            <tr>
                                                <td><?php echo $no++; ?></td>
                                                <td><?php echo $mysql['username']; ?></td>
                                                <td><?php echo $mysql['level']; ?></td>
                                                <td style="text-align: center; width: 15%">
                                                    <button type="button" class="btn btn-primary btn-sm btn-flat btn-xs" data-toggle="modal" data-target='#updateModal<?php echo $mysql["username"] ?>'><i class="fa fa-pencil"></i> Edit</button>
                                                    <button class="delete btn btn-danger btn-sm btn-flat btn-xs" type="button" id="delete" data-id="<?php echo $mysql['username']; ?>"><i class="fa fa-trash-o"></i> Delete</button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    <?php } ?>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="mediumModalLabel">Tambah Data Admin</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="./function/function_admin.php?act=tambahadmin" method="post" role="form">
        ...
        ?>
            <!-- Modals Edit Data -->
            <div class="modal fade" id="updateModal<?php echo $row["username"] ?>" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form action="./function/function_admin.php?act=updateadmin" method="post" role="form">

                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Username</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="id" name="id" class="form-control" value="<?php echo $row['username']; ?>" readonly required></div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Password</label></div>
                                    <div class="col-12 col-md-9"><input type="password" id="password" name="password" placeholder="Password" class="form-control" value="<?php echo $row['password']; ?>" required></div>
                                </div>
                                <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class="form-control-label">Level</label></div>
                                <div class="col-12 col-md-9">
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            ...
                            // })
                            $.ajax({
                                url: './function/function_admin.php',
                                method: 'GET',
                                data: {
                                    delete: 'deleteadmin',
                                    username: id
                                ...
                                success: function(data) {
                                    ...
                                    window.setTimeout(function() {
                                        window.location.href = 'tabel-admin.php';
                                    }, 1500);
                                }
                            })
                        } else {
