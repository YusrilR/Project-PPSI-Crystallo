        ...
        <div class="content mt-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="clearfix">
                            ...
                            <div class="text-muted text-uppercase font-weight-bold font-xs small">Admin</div>
                        </div>
                        <div class="b-b-1 pt-3"></div>
                        <hr>
                        <div class="more-info pt-2" style="margin-bottom:-10px;">
                            <a class="font-weight-bold font-xs btn-block text-muted small" href="tabel-admin.php">Lihat Data <i class="fa fa-angle-right float-right font-lg"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        <div class="clearfix">
                            <i class="fa fa-desktop bg-info p-3 font-2xl mr-3 float-left text-light"></i>
                            <?php
                            $data = mysqli_query($koneksi, "SELECT * FROM tabel_pegawai");
                            $jumlah = mysqli_num_rows($data);
                            ?>
                            <div class="h5 text-secondary mb-0 mt-1"><span class="count"><?php echo $jumlah; ?></span></div>
                            <div class="text-muted text-uppercase font-weight-bold font-xs small">Pegawai</div>
                        </div>
                        <div class="b-b-1 pt-3"></div>
                        <hr>
                        <div class="more-info pt-2" style="margin-bottom:-10px;">
                            <a class="font-weight-bold font-xs btn-block text-muted small" href="tabel-pegawai.php">Lihat Data <i class="fa fa-angle-right float-right font-lg"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        <div class="clearfix">
                            <i class="fa fa-wrench bg-warning p-3 font-2xl mr-3 float-left text-light"></i>
                            <?php
                            $data = mysqli_query($koneksi, "SELECT * FROM tabel_pekerja");
                            $jumlah = mysqli_num_rows($data);
                            ?>
                            <div class="h5 text-secondary mb-0 mt-1"><span class="count"><?php echo $jumlah; ?></span></div>
                            <div class="text-muted text-uppercase font-weight-bold font-xs small">Pekerja Produksi</div>
                        </div>
                        <div class="b-b-1 pt-3"></div>
                        <hr>
                        <div class="more-info pt-2" style="margin-bottom:-10px;">
                            <a class="font-weight-bold font-xs btn-block text-muted small" href="tabel-pekerjaproduksi.php">Lihat Data <i class="fa fa-angle-right float-right font-lg"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        <div class="clearfix">
                            <i class="fa fa-truck bg-danger p-3 font-2xl mr-3 float-left text-light"></i>
                            <?php
                            $data = mysqli_query($koneksi, "SELECT * FROM tabel_supplier");
                            $jumlah = mysqli_num_rows($data);
                            ?>
                            <div class="h5 text-secondary mb-0 mt-1"><span class="count"><?php echo $jumlah; ?></span></div>
                            <div class="text-muted text-uppercase font-weight-bold font-xs small">Supplier</div>
                        </div>
                        <div class="b-b-1 pt-3"></div>
                        <hr>
                        <div class="more-info pt-2" style="margin-bottom:-10px;">
                            <a class="font-weight-bold font-xs btn-block text-muted small" href="tabel-supplier.php">Lihat Data <i class="fa fa-angle-right float-right font-lg"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <a href="tabel-produk.php">
                    <div class="card">
                        <div class="card-body">
                            <div class="stat-widget-one">
                                <div class="stat-icon dib"><i class="ti-archive text-success border-success"></i></div>
                                <div class="stat-content dib">
                                    ...
                                    $jumlah = mysqli_num_rows($data);
                                    ?>
                                    <div class="stat-digit"><span class="count"><?php echo $jumlah; ?></span></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-md-6">
                <a href="transaksi-produkmasuk.php">
                    <div class="card">
                        <div class="card-body">
                            <div class="stat-widget-one">
                                <div class="stat-icon dib"><i class="ti-briefcase text-danger border-danger"></i></div>
                                <div class="stat-content dib">
                                    <div class="stat-text">Produk Masuk</div>
                                    <?php
                                    $data = mysqli_query($koneksi, "SELECT * FROM tabel_produkmasuk");
                                    $jumlah = mysqli_num_rows($data);
                                    ?>
                                    <div class="stat-digit"><span class="count"><?php echo $jumlah; ?></span></div>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="stat-widget-one">
                            ...
                            <div class="stat-content dib">
                                ...
                                <?php
                                $data = mysqli_query($koneksi, "SELECT SUM(Grand_Total) AS GT FROM tabel_pemesanan");
                                $jumlah = mysqli_fetch_array($data);
                                ?>
                                <div class="stat-digit"><?php echo rupiah($jumlah['GT']); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="stat-widget-one">
                            ...
                            <div class="stat-content dib">
                                ...
                                <?php
                                $data = mysqli_query($koneksi, "SELECT SUM(total) AS TB FROM tabel_bahanmasuk");
                                $jumlah = mysqli_fetch_array($data);
                                ?>
                                <div class="stat-digit"><?php echo rupiah($jumlah['TB']); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
