                    ...
                    <div class="modal-body">
                        <form action="./function/function_gaji.php?act=tambahgaji" method="post" role="form">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="Deskripsi" name="Deskripsi" class="Deskripsi form-control" readonly required>
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="Besar_Gaji" name="Besar_Gaji" class="form-control" required>
                        ...
                        <div class="modal-body">
                            <form action="./function/function_gaji.php?act=updategaji" method="post" role="form">
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Jenis Gaji</label></div>
                                    <div class="col-12 col-md-9">
                                    <select id="Jenis_Gaji_edit" class="Jenis_Gaji_edit form-control" required >
                                        <option value="Pegawai">Pegawai</option>
                                        <option value="Pekerja">Pekerja</option>
                                    </select>
                                </div>
