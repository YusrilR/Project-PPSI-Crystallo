...
$query = mysqli_query($koneksi, "SELECT max(id_produkmasuk) as kodeTerbesar FROM tabel_produkmasuk");
$data = mysqli_fetch_array($query);
$id_produkmasuk = $data['kodeTerbesar'];

$urutan = (int) substr($id_produkmasuk, 3, 3);

$urutan++;

$huruf = "PM";
$id_produkmasuk = $huruf . sprintf("%03s", $urutan);
...
<body>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="tabel-produksi.php">Produksi</a></li>
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Data Produk Masuk Gudang</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Data Produk Masuk Gudang</strong>
                                ...
                                <a target="_blank" href="cetak-produkmasuk.php" class="btn btn-warning btn-sm" style="float: right; margin-right: 10px"><i class="fa fa-print"></i>&nbsp; Export PDF</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="text-align: center; width: 15%">
                                                    <button type="button" class="btn btn-primary btn-sm btn-flat btn-xs" data-toggle="modal" data-target='#updateModal<?php echo $mysql["id_produkmasuk"] ?>'><i class="fa fa-pencil"></i> Edit</button>
                                                    <button class="delete btn btn-danger btn-sm btn-flat btn-xs" type="button" id="delete" data-id="<?php echo $mysql['id_produkmasuk']; ?>"><i class="fa fa-trash-o"></i> Delete</button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    <?php } ?>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="mediumModalLabel">Tambah Data Produk Masuk</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="./function/function_produkmasuk.php?act=tambahprodukmasuk" method="post" role="form">
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Id Produk Masuk</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="id_produkmasuk" name="id_produkmasuk" placeholder="Text" class="form-control" value="<?php echo $id_produkmasuk ?>" readonly></div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="id_pekerja" class="form-control">
                                        <option disabled selected>Pilih Nama Pekerja</option>
                                        <?php
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Jumlah Produk Masuk</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="jumlah" name="jumlah" placeholder="Jumlah Produk Masuk" class="form-control"></div>
                            </div>
                            <div class="row form-group">
        ...
        <?php
        $id_produkmasuk = $mysql['id_produkmasuk'];
        $query = "SELECT * FROM tabel_produkmasuk ORDER BY id_produkmasuk DESC";
        $result = mysqli_query($koneksi, $query);
        while ($row = mysqli_fetch_assoc($result)) {
            ?>
            <!-- Modals Edit Data -->
            <div class="modal fade" id="updateModal<?php echo $row["id_produkmasuk"] ?>" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form action="./function/function_produkmasuk.php?act=updateprodukmasuk" method="post" role="form">

                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Id Produk Masuk</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="id_produkmasuk" name="id_produkmasuk" placeholder="Text" class="form-control" value="<?php echo $row['id_produkmasuk']; ?>" readonly></div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nama Pekerja</label></div>
                                    <div class="col-12 col-md-9">
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            ...
                            // })
                            $.ajax({
                                url: './function/function_produkmasuk.php',
                                method: 'GET',
                                data: {
                                    delete: 'deleteprodukmasuk',
                                    id_produkmasuk: id
                                },
                                success: function(data) {
                                    ...
                                    window.setTimeout(function() {
                                        window.location.href = 'transaksi-produkmasuk.php';
                                    }, 1500);
                                }
                            })
                        } else {
